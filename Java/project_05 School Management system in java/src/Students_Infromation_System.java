...
public class Students_Infromation_System extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel11.setText("Class Teachers' Id");
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(48, 48, 48))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(txt_roll, javax.swing.GroupLayout.PREFERRED_SIZE, 267, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(141, 141, 141)
    ...
    private void cmd_searchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmd_searchActionPerformed
        ...
        try {
            ...
            if(rs.next())
            {
                ...
                //String add11=rs.getString("Class Teachers' ID");
               // txt_teacher_ID.setText(add11);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(p==0)
        {
            try {
                ...
                //String value11=txt_teacher_ID.getText();
